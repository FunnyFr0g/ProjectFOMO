...
def main():
    # Пути к файлам
    gt_file = gt_pathes['drones_only_FOMO_val']  # замените на путь к вашему файлу с GT
    pred_file = pred_pathes['drones_only_FOMO_val FOMO_56_104e']  # замените на путь к вашему файлу с предсказаниями
    ...
    plot_pr_curve(coco_eval, iou_thr=iou_threshold)
